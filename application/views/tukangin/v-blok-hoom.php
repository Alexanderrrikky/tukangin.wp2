		...
		<div class="row gx-5">
			<div class="col-xl-8">
				...
				<div class="mb-4">
					...
					<a class="link-dark" href="https://tukangincom13.blogspot.com/2024/06/adalah-seni-lukis-atau-gambar-yang.html">
						<h3>
							update tentang jasa pertukangan berbasis web dengan tema "Mural & cat"
						</h3>
					</a>
				</div>
				<!-- News item-->
				<div class="mb-5">
					...
					<a class="link-dark" href="https://tugaskomputerasik.blogspot.com/2024/06/jasa-renovasi-renovasi-tukangin-adalah.html">
						<h3>renopasi dan membangun kembali dengan bahan berkualitas "renovasi"</h3>
					</a>
				</div>
				<!-- News item-->
				<div class="mb-5">
					...
					<a class="link-dark" href="#!">
						<h3>
							perbaikan jalur air bersih di desa Urang Unsa "perbaikan saluran air"
						</h3>
					</a>
				</div>
		...
		<div class="row gx-5">
			<div class="col-lg-4 mb-5">
				<div class="card h-100 shadow border-0">
					<img class="card-img-top" src="<?= base_url('asset/img/blog/blog-air.jpg') ?>" alt="..." />
					<div class="card-body p-4">
						<div class="badge bg-primary bg-gradient rounded-pill mb-2">
							News
						</div>
					...
					<div class="card-footer p-4 pt-0 bg-transparent border-top-0">
						<div class="d-flex align-items-end justify-content-between">
							<div class="d-flex align-items-center">
								<img width="40" height="40" class="rounded-circle me-3" src="<?= base_url('asset/img/ales.jpg') ?>" alt="..." />
								<div class="small">
									<div class="fw-bold">Ales toteles</div>
