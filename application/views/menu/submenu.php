...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <a href="" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambahSubMenuModal">Tambah SubMenu Baru</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahSubMenuModalLabel">Tambah menu</h5>
