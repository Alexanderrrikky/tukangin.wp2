    	...
    	<div class="container px-5">
    		<div class="row gx-5 align-items-center justify-content-center">
    			...
    			<div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
    				<img class="img-fluid rounded-3 my-5" src="<?php echo base_url('asset/img/hoom.png'); ?>" alt="..." />
    			</div>
    		</div>
    	</div>
    </header>
    	...
    	<div class="container px-5 my-5">
    		<div class="row gx-5">
    			<div class="col-lg-4 mb-5 mb-lg-0">
    				<h2 class="fw-bolder mb-0">Bangun Istana Anda Dengan Tukang yang Berpengalaman.</h2>
    			</div>
    			<div class="col-lg-8">
